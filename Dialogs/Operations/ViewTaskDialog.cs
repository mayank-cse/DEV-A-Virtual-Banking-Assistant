...
namespace DevVirtualBankingAssistant.Dialogs.Operations
{
    public class ViewTaskDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> ShowTasksStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                await stepContext.Context.SendActivityAsync(MessageFactory.Text("You don't have any payment record added."), cancellationToken);
                return await stepContext.EndDialogAsync(null, cancellationToken);
            }
            await stepContext.Context.SendActivityAsync(MessageFactory.Text("Please find the below payment record you provided."), cancellationToken);
